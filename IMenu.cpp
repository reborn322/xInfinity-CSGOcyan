...
void Menu::DrawWatermark()
{
	...
	static std::string tag("xInfinity " + Utilities::VersionString);
...
void Menu::Draw()
{
	...
	// tab headers
	POINT cyanSize = Render::GetTextSize(Fonts::MENUBIG, "xInfinity ");
	Render::Text(location.x + 7, location.y + m_TabHeight - cyanSize.y - 3, Color(255, 5, 255), Fonts::MENUBIG, "xInfinity");
