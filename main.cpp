...
DWORD WINAPI init(LPVOID lpParam)
{
	...
	Utilities::Log("xInfinity " + Utilities::VersionString + " successfully injected");
	Utilities::csMessageBox("xInfinity " + Utilities::VersionString, "Injection successful.", true, false);

#ifdef __cyandbg
	while (!Utilities::unload)
		Sleep(1000);

	Utilities::Warn("Unloading xInfinity...");
